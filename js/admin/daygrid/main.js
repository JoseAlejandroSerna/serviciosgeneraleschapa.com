    ...
    */
    ...
    var SimpleDayGridEventRenderer = /** @class */ (function (_super) {
        ...
        SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
            ...
            //
            var claseEstatus = "";
            $.each(list_schedule, function(i, info) {
            	if (info.groupId == parseInt(core.htmlEscape(eventDef.groupId))) 
            	{
            		claseEstatus = "estatus-" + info.iStatus;
            	}
        	});
            //
            classes.unshift('fc-day-grid-event', 'fc-h-event',claseEstatus);
            ...
            titleHtml =
                '<span class="fc-title btnInfoCalendario" data-id="'+core.htmlEscape(eventDef.groupId)+'" onclick="ViewSchedule('+core.htmlEscape(eventDef.groupId)+');">' +
