                    ...
                    <div class="pb-10  bg-lineGradient">
                        <div class="container-fluid">
                            <div class="d-sm-flex align-items-center justify-content-between mb-top4">
                                <h2 class="h4 mb-0 pageH1 "><?php echo TITLE_SERVICE?></h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
					<form method="post" class="row" action="<?php echo $helper->url(CONTROLADOR_ADMIN_SERVICE,ACTION_DELETE); ?>" style="display:none;">
                                            							...
                                            							<div class="table-responsive">
                                                							<table id="export1234" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                                                ...
                                                                                <?php foreach($service as $info) {?>
																					<tr>
																						<td><?php echo $info->vService;?></td>
																						<td><?php echo $info->vInformation;?></td>
																						<td>
																							<img src="<?php echo PATH_SERVICE_WE_PROVIDE.$info->vImage; ?>" style="<?php echo STYLE_MAX_LOGO;?>">
																						</td>
																						<td>
																							<img src="<?php echo PATH_SERVICE_WE_PROVIDE.$info->vImage2; ?>" style="<?php echo STYLE_MAX_LOGO;?>">
																						</td>
																						
																						<td>
																							<span class="waves-effect waves-dark btn btn-outline-light text-success float-left" onclick="Edit(<?php echo $info->idService;?>)"><i data-feather="edit" data-toggle="tooltip" data-placement="top" title="Editar"></i></span>
																						
																							<span class="waves-effect waves-dark btn btn-outline-light text-danger float-left" onclick="Delete(<?php echo $info->idService;?>)"><i data-feather="trash-2" data-toggle="tooltip" data-placement="top" title="Eliminar"></i></span>
																						</td>
																					</tr>
                                                                                <?php } ?>
                                                    							</tbody>
													...
													<div class="modal animated zoomIn" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel6" aria-hidden="true">
                        								<div class="modal-dialog" role="document">
                            								<div class="modal-content">
																...
																<form method="post" action="<?php echo $helper->url(CONTROLADOR_ADMIN_SERVICE,ACTION_UPDATE); ?>" enctype="multipart/form-data">
																	<div class="modal-body">
																		<div class="row">
																			...
																			<div class="col-12 mb-3">
																				Imagen (medidas recomendadas 279x165)
																				<input type="file" class="form-control-file" id="image_edit" name="image_edit">
																			</div>
																			<div class="col-12 mb-3">
																				Imagen de detalle (medidas recomendadas 329x523)
																				<input type="file" class="form-control-file" id="image2_edit" name="image2_edit">
																			</div>

																			<input type="hidden" class="hdnId_update" 	name="hdnId_update" value=""/>

																			<input type="hidden" class="hdnImage" name="hdnImage" value=""/>
																			<input type="hidden" class="hdnImage2" name="hdnImage2" value=""/>
																		</div>
																	</div>
													...
													<div class="modal animated zoomIn" id="exampleModal7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel7" aria-hidden="true">
                        								<div class="modal-dialog" role="document">
                            								<div class="modal-content">
																...
																<form method="post" action="<?php echo $helper->url(CONTROLADOR_ADMIN_SERVICE,ACTION_CREATE); ?>" enctype="multipart/form-data">
																	<div class="modal-body">
																		<div class="row">
																			<div class="col-12 mb-3">
																				Titulo
																			...
																			<div class="col-12 mb-3">
																				Imagen de detalle (medidas recomendadas 329x523)
																				<input type="file" class="form-control-file" id="image2_new" name="image2_new">
																			</div>
																		</div>
																	</div>
