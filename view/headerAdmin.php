<head>
    ...
    <?php if($view == "AdminCalendar"){ ?>
        <link rel="stylesheet" href="css/admin/core/main.css">
        <link rel="stylesheet" href="css/admin/daygrid/main.min.css">
        <link rel="stylesheet" href="css/admin/timegrid/main.min.css">
        <link rel="stylesheet" href="css/admin/core/main.min.css">
    <?php } ?>

    <?php if($view == "AdminReportSale" || $view == "AdminReportRent" || $view == "AdminReportMaking" || $view == "AdminCard"){ ?>
